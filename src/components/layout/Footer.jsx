...
function Footer() {
  ...
  return (
    <footer className="bg-navy-800 text-white">
      {/* Supportive Message Banner - Trust Anchor */}
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center space-x-2 mb-4">
              <div className="w-10 h-10 bg-white rounded-full flex items-center justify-center">
                <span className="text-navy-800 font-bold text-lg">V</span>
              </div>
              <span className="text-xl font-bold">VEERU</span>
            </div>
            ...
            {/* Trust Signals - Minimal and Respectful */}
            <div className="mt-6 space-y-2">
              <p className="text-gray-400 text-xs">Working Since: 2018</p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              <li className="flex items-start space-x-2">
                <svg
                  className="w-5 h-5 text-forest-400 flex-shrink-0 mt-0.5"
                  fill="none"
                  viewBox="0 0 24 24"
                  stroke="currentColor"
                >
      ...
      <div className="border-t border-navy-700 py-4">
        <div className="section-container text-center text-gray-400 text-sm">
          <p>© {currentYear} VEERU. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
